...
mod tests {
    ...
    fn prep_dice_difference() {
        ...
        assert_eq!(
            fn_result,
            vec![
                (vec![1, 1, 0], 0.16666666666666666),
                (vec![1, 2, 0], 0.16666666666666666),
                (vec![1, 3, 0], 0.16666666666666666),
                (vec![2, 1, 0], 0.16666666666666666),
                (vec![2, 2, 0], 0.16666666666666666),
                (vec![2, 3, 0], 0.16666666666666666),
            ]
        )
    }
